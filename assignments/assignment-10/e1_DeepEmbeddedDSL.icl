 ...
 */
 ...
 /*
  * - Can you also make the iTask simulator work? If not, explain why.
  * The Expression type contains BM, which is a record type containing
  * functions a -> b and b -> a.
  * As Clean's webforms generated by iTasks cannot work for types
  * containing functions, it does not support BM, and as such it does
...
findFirstNPrimes n =
    ...
    while (size (Var "primes") <. Lit n) Do (
        ...
        If (Var "hasDivisor") Then (
            ...
            "primes" =. (SetPlus bm (Var "primes")  (set [1])) :.
            skip
        ) :.
        "cur" =. Var "cur" +. Lit 1
    ) :.
